...
public:
	...
	/////////////////////////////////////////////////////////////////////
	uint64_t numLogReg, numPhyReg, numMaxBranch, numActiveInst;
	/////////////////////////////////////////////////////////////////////
	...
	struct freelist_t
	{
		freelist_entries_t* Entry;
		headtail_t head, tail;
	};
	...
	// * Structure includes head, tail, and their phase bits.
	/////////////////////////////////////////////////////////////////////
	struct actlist_entries_t
	{
		bool dest_flag;
		uint64_t LogRegNumdest, PhyRegNumdest;
		bool compbit, excptbit, ldviobit, brmispbit, valmispbit, ldflag, strflag, brflag, amoflag, csrflag;
		uint64_t pc;
	};

	struct activelist_t
	{
		actlist_entries_t* Entry;
		headtail_t head, tail;
	};
	...
	/////////////////////////////////////////////////////////////////////
	struct prf_rdybit_array_t
	{
		bool readybit;
	};
	prf_rdybit_array_t* PRF_RdybitArr;
...
public:
	...
	bool stall_checkpoint(uint64_t bundle_inst);				// Proj4
	...
	/////////////////////////////////////////////////////////////////////
	void set_complete(uint64_t CheckpointID);
	...
	/////////////////////////////////////////////////////////////////////
	void set_exception(uint64_t CheckpointID);
	...
	/////////////////////////////////////////////////////////////////////
	bool get_exception(uint64_t CheckpointID);
};